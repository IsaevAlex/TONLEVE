...
#
  ...
  ProductCategory.create([{ name: "Одежда и аксессуары для женщин"},{ name: "Одежда и аксессуары для мужчин"},{ name: "Телефоны и телекоммуникации"},{ name: "Детские товары"},{ name: "Автомобили и мотоциклы"},{ name: "Ювелирные изделия"}, 
            						  { name: "Часы"}, 
